...
namespace GiroLouco.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idcliente,nomecliente,sobrenome,cpf")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idcliente,nomecliente,sobrenome,cpf")] Clientes clientes)
        {
